...
describe "invoice_items" do
  describe "GET find_all" do
    it "returns all matching invoice_items by id" do
      ...
      expect(invoice_item_json.first["unit_price"]).to eq invoice_item.unit_price
    end
    ...
    it "returns all matching invoice_items by quantity" do
      ...
      expect(invoice_items_json.first["unit_price"]).to eq invoice_item1.unit_price
      ...
      expect(invoice_items_json.last["unit_price"]).to eq invoice_item2.unit_price
    end

    it "returns all matching invoice_items by unit_price" do
      invoice_item1 = create(:invoice_item, unit_price: "12345")
      invoice_item2 = create(:invoice_item, unit_price: "12345")
